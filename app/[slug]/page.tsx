...
const getImageForPost = (title: string) => {
  ...
  if (t.includes('how much') && t.includes('cash home buyers')) return '/images/cash-house-money.png'
...
export default function Page({ params }: { params: { slug: string } }) {
  ...
  // NOTE: The content is missing because your SITE_CONTENT object in lib/siteContent.ts
  // likely doesn't have the 'content' property populated for blog posts.
  // Please add the full text from your content pack to SITE_CONTENT.
                ...
                if (paragraph.trim().startsWith('- ')) {
                  return (
                    <div key={index} className="flex items-start gap-3 mb-4 ml-4">
                      ...
                      <p className="text-white/80 leading-relaxed">{paragraph.replace('- ', '')}</p>
                    </div>
                  )
                }
