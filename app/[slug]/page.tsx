...
export default function Page({ params }: { params: { slug: string } }) {
  ...
  const slugToImage: Record<string, string> = {
    ...
    // Match the HOA/code violations tile on the homepage
    ...
    // Match the inherited property/probate tile on the homepage
    'probate-help': '/images/inheritance-estate-family-inherited-probate-cash-offer.jpg',
    // Ensure the inherited property guide uses the same hero as the probate-help situation card
  ...
  return (
    ...
    <main className="bg-[#0F1C2E] min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        {/* If this page is a blog post, return to the blog index; otherwise return to home */}
        <Link
          href={data.type === 'blog' ? '/blog' : '/'}
          className="inline-flex items-center text-white/70 hover:text-[#C5A572] transition-colors"
        >
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="mt-20 bg-[#1B365D] rounded-2xl p-10 border border-[#C5A572]/20 text-center">
          ...
          <p className="text-white/70 mb-8 max-w-2xl mx-auto">
            ...
            Looking to sell in Central Florida?{' '}
            <Link href="/sell-house-fast-orlando" className="underline text-[#C5A572] hover:text-[#D4B896]">
              Learn about our Orlando cash buyer services
            </Link>
            .
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/#contact"
              className="bg-gradient-to-r from-[#B8860B] to-[#C5A572] text-[#0F1C2E] px-8 py-3 rounded-lg font-bold hover:from-[#C5A572] hover:to-[#D4B896] transition-colors"
            >
              Get A Cash Offer
            </Link>
            <a
              href="tel:2392913444"
              className="bg-transparent border border-[#C5A572] text-white px-8 py-3 rounded-lg font-bold hover:bg-[#C5A572]/10 transition-colors flex items-center justify-center"
            >
