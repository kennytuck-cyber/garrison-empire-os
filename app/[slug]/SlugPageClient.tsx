...
export default function SlugPageClient({ slug, data }: { slug: string; data: any }) {
  ...
  const heroImage = slugToImage[slug] ?? getImageForPost(data.h1 || '')
  ...
  const localBusinessSchema = data.type === 'location' ? {
    ...
    "@type": "LocalBusiness",
    "@id": `https://garrisonpointsolutions.com/${slug}`,
    "name": "Garrison Point Solutions",
    "description": data.description,
    "url": `https://garrisonpointsolutions.com/${slug}`,
