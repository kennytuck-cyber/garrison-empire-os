...
export default function Navbar() {
  ...
  return (
    ...
    */}
    <nav className="fixed w-full bg-[#152947]/90 backdrop-blur-md z-50 border-b border-[#C5A572]/15">
      ...
      */}
      {isOpen && (
        <div className="lg:hidden absolute left-0 right-0 top-full bg-[#152947] border-t border-[#C5A572]/15 px-6 pt-4 pb-8 space-y-4 shadow-lg">
          <Link
            href="/#how-it-works"
