...
export default function LeadConcierge() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      // Set a flag to indicate that the chat has been initialized.  We no longer unmount the component
      // when the flag is present; instead we rely on localStorage and the chat opener button to
      // control visibility.  This allows the chat to appear on multiple pages without duplication.
