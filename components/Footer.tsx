...
export default function Footer() {
  return (
    <footer className="bg-[#152947] border-t border-[#C5A572]/15 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-12">
          {/* Logo & About */}
          <div className="md:col-span-2">
            <div className="flex items-center mb-6">
              <img src="/logo Background Removed.png" alt="Garrison Point Solutions logo" className="h-20 w-auto" />
              <span className="ml-4 font-serif font-bold text-[#C5A572] text-3xl">Garrison Point Solutions</span>
            </div>
