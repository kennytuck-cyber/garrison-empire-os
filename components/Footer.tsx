        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2 text-center">
            <div className="flex flex-col items-center mb-6">
              {/* Double-sized logo for more impact */}
              <img src="/logo Background Removed.png" alt="Garrison Point Solutions logo" className="h-40 w-auto" />
              <span className="mt-4 font-serif font-bold text-[#C5A572] text-3xl">Garrison Point Solutions</span>
            </div>
