...
export const SITE_CONTENT = {
  ...
  'foreclosure-help': {
    ...
    description: 'Facing foreclosure? Learn how to stop the process and sell your house quickly for cash in Florida.',
    h1: 'Foreclosure Help in Florida',
    intro: "If you're behind on payments and facing foreclosure, time is critical. We specialize in buying homes before the auction so you can save your equity.",
    content: CONTENT_MAP['foreclosure-help'],
  },
  'code-violations': {
    type: 'situation',
    title: 'Sell a House With Code Violations in Florida',
    description: 'Have code violations or liens? Discover how to sell a property with fines and unpermitted work without fixing anything yourself.',
    h1: 'Selling a House With Code Violations in Florida',
    intro: 'Daily fines and liens can quickly become overwhelming. Learn how to sell your property as-is, even with open permits or violations.',
    content: CONTENT_MAP['code-violations'],
  },
  'military-relocation': {
    type: 'situation',
    title: 'Sell Your Home During Military Relocation',
    description: 'PCS orders? We buy houses fast so you can relocate without the burden of a long sale.',
    h1: 'Selling a House During Military Relocation',
    intro: 'Permanent Change of Station orders leave little time to list your home. We offer fast cash purchases so you can focus on your move.',
    content: CONTENT_MAP['military-relocation'],
  },
  'probate-help': {
    type: 'situation',
    title: 'Probate & Inherited Property Assistance in Florida',
    description: 'Navigate probate smoothly. Learn how to sell inherited property for cash and divide proceeds quickly.',
    h1: 'Probate & Inherited Property Assistance in Florida',
    intro: 'Inheriting a home can be a blessing and a burden. We help heirs convert real estate into cash during and after probate.',
    content: CONTENT_MAP['probate-help'],
  },
  'divorce-sale': {
    type: 'situation',
    title: 'Selling a House During Divorce in Florida',
    description: 'Divorce settlements are simpler with a cash sale. Find out how to divide equity quickly and fairly.',
    h1: 'Selling a House During Divorce in Florida',
    intro: 'We provide a neutral third-party purchase to help both spouses move on without the hassle of listing and repairs.',
    content: CONTENT_MAP['divorce-sale'],
  },
  'sell-damaged-house': {
    type: 'situation',
    title: 'Sell a Damaged or Flooded House in Florida',
    description: 'Storm or flood damage? You can still sell your house for cash without making repairs.',
    h1: 'Sell a Damaged or Flooded House in Florida',
    intro: 'Hurricanes, fires and floods can make a home unsafe. We buy properties as-is so you can move on quickly.',
